...
namespace AdvancedQueryOrganizer
{
    public static class DynamicDataSourceCode
    {
        ...
        public static string GetProcedureRun(string sConnectionString, string Name)
        {
        ...
        public static async Task<string> GetProcedureDefinition(string sConnectionString, string Name, string sType)
        {
